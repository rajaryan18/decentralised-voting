        ...
        <div key={props.id} className='rounded-md  bg-[#252945] hover:scale-110 duration-300 hover:shadow-md hover:shadow-black/75 w-48 mb-4 mt-4 mx-6 ' >
            ...
            <div className=" max-w-sm border border-gray-200 rounded-lg shadow">
                ...
                <div className="px-4 py-3">
                    ...
                    <Link href={`/election/${props.goto}`} className="inline-flex hover:cursor-pointer text-xs items-center px-3 py-2 font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        More Details
