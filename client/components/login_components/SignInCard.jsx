        ...
        <div className='di relative sm:h-[300px] sm:w-[500px] h-[300px] w-[300px] mb-20 overflow-hidden rounded-xl bg-[#111526] mt-12 '>
            <div className="absolute z-20 inset-[1.5px] rounded-[12px] ">
                <div className="bg-[#283457] text-white px-2 py-3  rounded-t-xl h-[130px]">
                    ...
                    <div className='mx-auto items-center flex justify-center'><input type="text" placeholder="Enter your Aadhar no" className=' outline-none text-black rounded-xl h-[40px] w-[82%]  mt-7  px-5 py-3'></input></div>
                </div>
                <div className='mx-auto items-center flex justify-center'><input type="text" placeholder="Password" className=' outline-none text-black rounded-xl h-[40px] w-[80%]  mt-3 mb-1   px-5 py-3'></input></div>
