    ...
    return (
        ...
        <div className='di relative sm:h-[300px] sm:w-[500px] h-[300px] w-[300px] mb-20 overflow-hidden rounded-xl bg-[#111526] mt-12 '>
            <div className="absolute z-20 inset-[1.5px] rounded-[12px] ">
                ...
                <button onClick={handleSignIn} className=" bg-gradient-to-r flex from-[#60e0e6] to-[#03b7c1] cursor-pointer hover:scale-105 duration-200 hover:shadow-lg shadow-black  bg-[] h-[50px] w-[80%] justify-center text-white rounded-xl mt-3 mx-auto text-center py-3">
                    Sign In

                </button>
                <p className='text-white text-sm text-center mt-4'>New to Dection? <a onClick={props.on} className=' underline hover:text-blue-300 cursor-pointer'>Sign up</a></p>
            </div>
        </div>
