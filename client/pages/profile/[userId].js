    ...
    return (
      <div className="bg-primary bg-[#01040f]">
        ...
        <div className=" flex  flex-col px-3 sm:px-10 lg:px-24 md:px-20 ">
          <div className="upperborder h-44 w-full bg-[#1e2742] rounded-t-3xl mt-10 flex items-center justify-center text-center ">
            {" "}
            <div className="image md:hidden bg-white rounded-full h-32 w-32 "></div>
          </div>
          <div className="flex flex-row">
            <div className="hidden rounded-full bg-[#01040f] h-40 w-40 md:flex items-center justify-center ml-10 -mt-20">
              {" "}
              <div className="image bg-white rounded-full h-36 w-36 "></div>{" "}
            </div>
            <div className="Name text-white mt-5 md:mt-2 ml-3 flex flex-col">
              <div className="text-4xl font-epilogue">{userData.name}</div>
              <div className="info mt-6">
                <div className="aadhar text-white  font-epilogue">
                  Aadhar Number: {aadhar_num}
                </div>
                <div className="dob text-white mt-1 font-epilogue">
                  DOB: {userData.dob}
                </div>
              </div>
            </div>
